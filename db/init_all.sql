...
CREATE TABLE IF NOT EXISTS `aware_debug` (
  `_id` INT UNSIGNED AUTO_INCREMENT PRIMARY KEY,
  `timestamp` DOUBLE NOT NULL,
  `device_id` VARCHAR(128) NOT NULL,
  `data` JSON NOT NULL,
...
CREATE TABLE IF NOT EXISTS `labels_boolean` (
  `_id` INT UNSIGNED AUTO_INCREMENT PRIMARY KEY,
  `timestamp` DOUBLE NOT NULL,
  `device_id` VARCHAR(128) NOT NULL,
  `data` JSON NOT NULL,
...
-- Client logs
CREATE TABLE IF NOT EXISTS `ios_aware_log` (
  `_id` INT UNSIGNED AUTO_INCREMENT PRIMARY KEY,
  `timestamp` DOUBLE NOT NULL,
  `device_id` VARCHAR(128) NOT NULL,
  `data` JSON NOT NULL,
...
CREATE TABLE IF NOT EXISTS `ios_status_monitor` (
  `_id` INT UNSIGNED AUTO_INCREMENT PRIMARY KEY,
  `timestamp` DOUBLE NOT NULL,
  `device_id` VARCHAR(128) NOT NULL,
  `data` JSON NOT NULL,
...
-- Location extras
CREATE TABLE IF NOT EXISTS `google_fused_location` (
  `_id` INT UNSIGNED AUTO_INCREMENT PRIMARY KEY,
  `timestamp` DOUBLE NOT NULL,
  `device_id` VARCHAR(128) NOT NULL,
  `data` JSON NOT NULL,
...
CREATE TABLE IF NOT EXISTS `ios_location_visit` (
  `_id` INT UNSIGNED AUTO_INCREMENT PRIMARY KEY,
  `timestamp` DOUBLE NOT NULL,
  `device_id` VARCHAR(128) NOT NULL,
  `data` JSON NOT NULL,
...
CREATE TABLE IF NOT EXISTS `plugin_ble_heartrate` (
  `_id` INT UNSIGNED AUTO_INCREMENT PRIMARY KEY,
  `timestamp` DOUBLE NOT NULL,
  `device_id` VARCHAR(128) NOT NULL,
  `data` JSON NOT NULL,
...
CREATE TABLE IF NOT EXISTS `plugin_calendar` (
  `_id` INT UNSIGNED AUTO_INCREMENT PRIMARY KEY,
  `timestamp` DOUBLE NOT NULL,
  `device_id` VARCHAR(128) NOT NULL,
  `data` JSON NOT NULL,
...
CREATE TABLE IF NOT EXISTS `plugin_calendar_esm_scheduler` (
  `_id` INT UNSIGNED AUTO_INCREMENT PRIMARY KEY,
  `timestamp` DOUBLE NOT NULL,
  `device_id` VARCHAR(128) NOT NULL,
  `data` JSON NOT NULL,
...
CREATE TABLE IF NOT EXISTS `plugin_fitbit` (
  `_id` INT UNSIGNED AUTO_INCREMENT PRIMARY KEY,
  `timestamp` DOUBLE NOT NULL,
  `device_id` VARCHAR(128) NOT NULL,
  `data` JSON NOT NULL,
...
CREATE TABLE IF NOT EXISTS `fitbit_device` (
  `_id` INT UNSIGNED AUTO_INCREMENT PRIMARY KEY,
  `timestamp` DOUBLE NOT NULL,
  `device_id` VARCHAR(128) NOT NULL,
  `data` JSON NOT NULL,
...
CREATE TABLE IF NOT EXISTS `plugin_headphone_motion` (
  `_id` INT UNSIGNED AUTO_INCREMENT PRIMARY KEY,
  `timestamp` DOUBLE NOT NULL,
  `device_id` VARCHAR(128) NOT NULL,
  `data` JSON NOT NULL,
...
CREATE TABLE IF NOT EXISTS `plugin_ios_activity_recognition` (
  `_id` INT UNSIGNED AUTO_INCREMENT PRIMARY KEY,
  `timestamp` DOUBLE NOT NULL,
  `device_id` VARCHAR(128) NOT NULL,
  `data` JSON NOT NULL,
...
CREATE TABLE IF NOT EXISTS `plugin_ios_esm` (
  `_id` INT UNSIGNED AUTO_INCREMENT PRIMARY KEY,
  `timestamp` DOUBLE NOT NULL,
  `device_id` VARCHAR(128) NOT NULL,
  `data` JSON NOT NULL,
...
CREATE TABLE IF NOT EXISTS `plugin_ios_pedometer` (
  `_id` INT UNSIGNED AUTO_INCREMENT PRIMARY KEY,
  `timestamp` DOUBLE NOT NULL,
  `device_id` VARCHAR(128) NOT NULL,
  `data` JSON NOT NULL,
...
CREATE TABLE IF NOT EXISTS `plugin_ntptime` (
  `_id` INT UNSIGNED AUTO_INCREMENT PRIMARY KEY,
  `timestamp` DOUBLE NOT NULL,
  `device_id` VARCHAR(128) NOT NULL,
  `data` JSON NOT NULL,
...
CREATE TABLE IF NOT EXISTS `plugin_studentlife_audio` (
  `_id` INT UNSIGNED AUTO_INCREMENT PRIMARY KEY,
  `timestamp` DOUBLE NOT NULL,
  `device_id` VARCHAR(128) NOT NULL,
  `data` JSON NOT NULL,
...
-- HealthKit
CREATE TABLE IF NOT EXISTS `health_kit` (
  `_id` INT UNSIGNED AUTO_INCREMENT PRIMARY KEY,
  `timestamp` DOUBLE NOT NULL,
  `device_id` VARCHAR(128) NOT NULL,
  `data` JSON NOT NULL,
...
CREATE TABLE IF NOT EXISTS `health_kit_category` (
  `_id` INT UNSIGNED AUTO_INCREMENT PRIMARY KEY,
  `timestamp` DOUBLE NOT NULL,
  `device_id` VARCHAR(128) NOT NULL,
  `data` JSON NOT NULL,
...
CREATE TABLE IF NOT EXISTS `health_kit_quantity` (
  `_id` INT UNSIGNED AUTO_INCREMENT PRIMARY KEY,
  `timestamp` DOUBLE NOT NULL,
  `device_id` VARCHAR(128) NOT NULL,
  `data` JSON NOT NULL,
...
CREATE TABLE IF NOT EXISTS `health_kit_workout` (
  `_id` INT UNSIGNED AUTO_INCREMENT PRIMARY KEY,
  `timestamp` DOUBLE NOT NULL,
  `device_id` VARCHAR(128) NOT NULL,
  `data` JSON NOT NULL,
