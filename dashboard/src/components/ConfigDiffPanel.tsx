...
function DiffCell({ value }: { value: unknown }) {
  ...
  return (
    <td
      className={`px-3 py-2 align-top font-mono text-[12px] wrap-break-word ${
  ...
  return (
    <>
      <tr>
        <th
          colSpan={3}
          className="bg-card-strong/70 px-3 py-1.5 text-left text-[11px] font-semibold uppercase tracking-[0.5px] text-sage"
        >
      ...
      {rows.map((row) => (
        <tr key={row.path} className="border-t border-wire">
          <td className="px-3 py-2 align-top font-mono text-[12px] font-semibold text-ink wrap-break-word">
            {row.path}
          </td>
  ...
  return (
    <section className="rounded-3xl border border-wire bg-card p-5 shadow-card backdrop-blur-xl">
      <div className="mb-3 flex flex-wrap items-baseline justify-between gap-2">
        <h2 className="text-[16px] font-bold text-ink">Config differences</h2>
      ...
      {unknown ? (
        <div className="rounded-2xl border border-wire bg-card-strong/70 p-6 text-center text-[14px] text-sage">
        ...
        <div className="rounded-2xl border border-wire bg-teal-soft/40 p-6 text-center text-[14px] text-teal">
        ...
        <div className="overflow-x-auto rounded-2xl border border-wire">
          <table className="w-full border-collapse text-left">
            <thead>
              <tr className="text-[11px] uppercase tracking-[0.5px] text-sage">
