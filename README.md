...
| **A researcher keeping a deployment running**          | [Maintenance](docs/guide/maintenance.md) — taking a new version, rotating a credential, and operations against the database                                                                                      |
